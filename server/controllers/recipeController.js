...
exports.submitRecipe = async (req, res) => {
    ...
    res.render('submit-recipe', { title: 'Cooking Blog - Submit Recipe', infoErrorsObj, infoSubmitObj, categories });
...
//     try {
//         const res = await Recipe.updateOne({ name: 'Test' }, { name: 'Updated Test' });
...
//     try {
//         await Recipe.deleteOne({ name: 'Updated Test' });
//     } catch (error) {
//         console.log(error);
//     }
// }
